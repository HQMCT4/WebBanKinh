...
=======
<?php
include("../include/login-taikhoan.php");
?>
...
<head>
    ...
    <link href="../../Content/DangNhap.css" rel="stylesheet" />
...
<div class="form" @*onsubmit="return false" autocomplete="off"*@>
    <div class="form-inner">
        <h2>User Login</h2>
            <div class="input-wrapper">
                <label for="login-username">Tải Khoản</label>
            ...
            <div class="btn-group">
                <button class="btn btn--primary" style="margin-top:15px">Sign in</button><a class="btn--text" href="#0" style="margin-top:15px">Forgot password?</a>
            </div>
    </div>
</div>
=======
        <div class="form">
            <form class="form-inner" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <h2>User Login</h2>
                <div class="input-wrapper">
                    <label for="user">Tải Khoản</label>
                    <div class="input-group">
                        <span class="icon">
                            <svg viewBox="0 0 24 24">
                                <path d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"></path>
                        ...
                        <input class="text w3lpass" type="text" name="user" id="user" placeholder="Tài Khoản" required="">
                        <p><?php if ($userErr != 1) {
                                echo $userErr;
                            } ?></p>
                    </div>
                ...
                <div class="input-wrapper">
                    ...
                    <div class="input-group">
                        ...
                        <input class="text w3lpass" type="password" name="password" id="password" placeholder="Mật Khẩu" required="">
                        <p><?php if ($passErr != 1) {
                                echo $passErr;
                            } ?></p>
                    </div>
                ...
                <div class="btn-group">
                    <input class="btn btn--primary" style="margin-top:15px" type="submit" value="login" name="register"></input>
                    <a class="btn--text" href="#0" style="margin-top:15px">Quên mật khẩu?</a>
                </div>
            </form>
        </div>
    </div>
