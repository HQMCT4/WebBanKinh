...
if($_SERVER['REQUEST_METHOD']=='POST'){
    include("./connectdb.php");
        ...
        $sql="select * from admin where TK='$usern' and MK='$pass'";
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form method="post">
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" class="form-control form-control-lg" name="TK" autocomplete="off"/>
                            <label class="form-label" for="form3Example3">Tên đăng nhập</label>
                        </div>

                        <!-- Password input -->
                        <div class="form-outline mb-3">
                            <input type="password" class="form-control form-control-lg" name="MK" />
