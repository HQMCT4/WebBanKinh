            ...
            <tbody>
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td>' . $SoDienThoaiKH . '</td>
                        <td>
                        <button class="btn btn-secondary"><a href="../qlkhachhang/suakhachhang.php?chinhsuaid=' . $id . '" class="text-light">Chỉnh sửa</a></button>
                        <button class="btn btn-danger"><a href="../qlkhachhang/xoakhachhang.php?xoaid=' . $id . '" class="text-light">Xóa</a></button>
                        </td>
                    </tr>';
                    }
                }
